...
FIRST_NAMES = ["James","Mary","John","Patricia","Robert","Jennifer","Michael","Linda",
    "David","Elizabeth","Sarah","Daniel","Karen","Matthew","Nancy","Anthony","Lisa",
    "Priya","Wei","Fatima","Chen","Amir","Sofia","Liam","Noah","Olivia","Emma","Ava"]
LAST_NAMES = ["Smith","Johnson","Williams","Brown","Jones","Garcia","Miller","Davis",
    "Rodriguez","Martinez","Wilson","Lee","Patel","Kim","Nguyen","Singh","Chan","Khan",
    "Tremblay","Roy","Gagnon","Cote"]
CITIES = [("Toronto","ON"),("Mississauga","ON"),("Ottawa","ON"),("Hamilton","ON"),
    ("Vancouver","BC"),("Surrey","BC"),("Calgary","AB"),("Edmonton","AB"),
    ("Montreal","QC"),("Quebec City","QC"),("Winnipeg","MB"),("Halifax","NS")]
...
df_product = pd.DataFrame(PRODUCTS, columns=["product_id","product_name","product_category"])
...
for i in range(1, N_CUSTOMERS + 1):
    ...
    name_variant = f"{fname} {lname}" if random.random() > 0.1 else f"{fname.upper()} {lname.lower()}"
...
for i in range(1, N_ACCOUNTS + 1):
    ...
    account_rows.append({
        ...
        "account_type": atype,
        "open_date": open_date,
        "status": random.choices(["active","closed","dormant"], weights=[0.85,0.1,0.05])[0],
    })
...
loan_products = df_product[df_product["product_category"] == "loan"]["product_id"].tolist()
loan_rows = []
